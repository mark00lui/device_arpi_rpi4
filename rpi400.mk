...
PRODUCT_NAME := rpi400
PRODUCT_DEVICE := rpi400
PRODUCT_BRAND := arpi
PRODUCT_MANUFACTURER := ARPi
PRODUCT_MODEL := Raspberry Pi 400
...
PRODUCT_COPY_FILES := \
    ...
    $(LOCAL_PATH)/bluetooth/bt_vendor_400.conf:system/etc/bluetooth/bt_vendor.conf \
    $(PRODUCT_COPY_FILES)
...
PRODUCT_COPY_FILES += \
     ...
     hardware/ril/libquectel-ril/system_lib/lib64/libstdc++.so:/vendor/lib64/libstdc++.so
